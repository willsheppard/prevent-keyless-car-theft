...
| `models` | string | no | Which specific models or years this instruction applies to (e.g. `"Fiesta 2016, Focus 2017 onwards"`). Displayed in muted text next to the type tag. |
| `text` | string | no | Prose description of the instruction, used when there are no discrete steps or as a preamble before `steps`. |
